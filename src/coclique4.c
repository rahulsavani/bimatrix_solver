 ...
 *
    update 28 Jan 2019:
    allow up to 263000 edges (a bit more than 2^18) as input (was 5000 before)
...
#define MAXINP1 263000        /* max. no of left nodes in input */
#define MAXINP2 MAXINP1  /* max. no of right nodes in input */
#define MAXEDGES 263000       /* max. no of edges in input */
...
static int  firstedge[MAXCO];
static struct edge edgelist[MAXEDGES];
